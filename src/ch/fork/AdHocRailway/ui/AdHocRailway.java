...
public class AdHocRailway extends
    JFrame implements
    CommandDataListener,
    InfoDataListener
{
    ...
    {
        super(NAME);
        setIconImage(createImageIcon("icons/RailControl.png",
            "RailControl",
        ...
        //} else {
            switchesControlPanel.update(SwitchControl.getInstance().getSwitchGroups());
            locomotiveControlPanel.update(LocomotiveControl.getInstance().getLocomotiveGroups());
        //}
    ...
    private void initGUI()
    {
        ...
        JScrollPane locomotiveControlPane = new JScrollPane(locomotiveControlPanel);
        initMenu();
        initToolbar();
        initStatusBar();

        JPanel switchesAndLocomotivesPanel = new JPanel(new BorderLayout(5,
            5));
        switchesAndLocomotivesPanel.add(switchesControlPanel,
            BorderLayout.CENTER);

        switchesAndLocomotivesPanel.add(locomotiveControlPane,
            BorderLayout.SOUTH);
        add(switchesAndLocomotivesPanel,
            BorderLayout.CENTER);
        add(statusBarPanel,
            BorderLayout.SOUTH);
    ...
    public String toXML()
    {
        ...
        sb.append("<RailControl xmlns=\"http://www.fork.ch/RailControl\" " + "ExporterVersion=\"0.1\">\n");
        sb.append("<SwitchConfiguration>\n");
        for (SwitchGroup sg : SwitchControl.getInstance()
            .getSwitchGroups()) {
            sb.append(sg.toXML());
        }
        sb.append("</SwitchConfiguration>\n");
        ...
        sb.append("</LocomotiveConfiguration>\n");
        sb.append(Preferences.getInstance()
            .toXML());
    ...
    public void updateCommandHistory(String text)
    {
        ...
        String date = df.format(GregorianCalendar.getInstance()
            .getTime());
    ...
    private class CommandHistoryUpdater implements
        Runnable
    {
        ...
        public void run()
        {
            ...
            commandHistoryModel.insertElementAt(text,
                0);
    ...
    protected class OpenAction extends
        AbstractAction
    {
        ...
        {
            super("Open file...",
                createImageIcon("icons/fileopen.png",
                    "File open...",
                    AdHocRailway.this));
        }
        ...
        private void openFile(File file)
        {
            ...
            try {
                XMLImporter importer = new XMLImporter(Preferences.getInstance(),
                ...
                recentFilesMenu.add(recentItem,
                    0);
                ...
                ExceptionProcessor.getInstance()
                    .processException("Error unregistering locomotives",
                        e);
            }
        }
    ...
    protected class SaveAsAction extends
        AbstractAction
    {
        public SaveAsAction()
        {
            super("Save as...",
                createImageIcon("icons/filesaveas.png",
                    "Save as...",
                    AdHocRailway.this));
        }
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    updateCommandHistory("Configuration saved: " + file.getName());
                } catch (IOException e1) {
                    ExceptionProcessor.getInstance()
                        .processException("Error writing file",
                            e1);
                } finally {
                    try {
                        fileWriter.close();
    ...
    protected class SaveAction extends
        AbstractAction
    {
        public SaveAction()
        {
            super("Save",
                createImageIcon("icons/filesave.png",
                    "Save",
                    AdHocRailway.this));
        }
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            if (actualFile != null) {
                ...
                try {
                    ...
                    fileWriter.write(xmlConfig);
                    updateCommandHistory("Configuration saved: " + actualFile.getName());
                } catch (IOException e1) {
                    ExceptionProcessor.getInstance()
                        .processException("Error writing file",
                            e1);
    ...
    protected class ExitAction extends
        AbstractAction
    {
        public ExitAction()
        {
            super("Exit",
                createImageIcon("icons/exit.png",
                    "Exit",
                    AdHocRailway.this));
        }
    ...
    protected class SwitchesAction extends
        AbstractAction
    {
        public SwitchesAction()
        {
            super("Switches",
                createImageIcon("icons/switch.png",
                    "Switches",
                    AdHocRailway.this));
        }
        ...
        public void actionPerformed(ActionEvent e)
        {
            SwitchConfigurationDialog switchConfig = new SwitchConfigurationDialog(AdHocRailway.this,
    ...
    protected class LocomotivesAction extends
        AbstractAction
    {
        public LocomotivesAction()
        {
            super("Locomotives",
                createImageIcon("icons/locomotive.png",
                    "Locomotives",
                    AdHocRailway.this));
        }
        ...
        {
            LocomotiveControl lc = LocomotiveControl.getInstance();
            LocomotiveConfigurationDialog locomotiveConfig = new LocomotiveConfigurationDialog(AdHocRailway.this,
                Preferences.getInstance());
            if (locomotiveConfig.isOkPressed()) {
                try {
                    ...
                    lc.registerLocomotiveGroups(locomotiveConfig.getLocomotiveGroups());
                    locomotiveControlPanel.update(lc.getLocomotiveGroups());
    ...
    protected class PreferencesAction extends
        AbstractAction
    {
        public PreferencesAction()
        {
            super("Preferences",
                createImageIcon("icons/package_settings.png",
                    "Preferences",
                    AdHocRailway.this));
        }
     ...
     * @author fork
     */
    protected class ConnectAction extends
        AbstractAction
    {
        public ConnectAction()
        {
            super("Connect",
                createImageIcon("icons/daemonconnect.png",
                    "Connect",
                    AdHocRailway.this));
        }
        ...
        public void actionPerformed(ActionEvent e)
        {
            try {
                String host = Preferences.getInstance()
                    .getStringValue("Hostname");
                int port = Preferences.getInstance()
                    .getIntValue("Portnumber");
                session = new SRCPSession(host,
                    port,
                    false);

                session.getCommandChannel()
                    .addCommandDataListener(AdHocRailway.this);
                session.getInfoChannel()
                    .addInfoDataListener(AdHocRailway.this);

                SwitchControl.getInstance()
                    .setSession(session);
                ...
                if (e1.getCause() instanceof ConnectException) {
                    ExceptionProcessor.getInstance()
                        .processException("Server not running",
                            e1);
                }
            }
        }
    ...
    protected class DisconnectAction extends
        AbstractAction
    {
        public DisconnectAction()
        {
            super("Disconnect",
                createImageIcon("icons/daemondisconnect.png",
                    "Disconnect",
                    AdHocRailway.this));
        }
    ...
    protected class ResetAction extends
        AbstractAction
    {
        public ResetAction()
        {
            super("Reset",
                createImageIcon("icons/daemonreset.png",
                    "Reset",
                    AdHocRailway.this));
        }
    ...
    protected class RefreshAction extends
        AbstractAction
    {
        public RefreshAction()
        {
            super("Refresh",
                createImageIcon("icons/reload.png",
                    "Refresh",
                    AdHocRailway.this));
        }
    ...
    protected class SwitchProgrammerAction extends
        AbstractAction
    {
        public SwitchProgrammerAction()
        {
            super("SwitchProgrammer",
                createImageIcon("icons/switch.png",
                    "SwitchProgrammer",
                    AdHocRailway.this));
        }
    ...
    protected class SwitchesStraightAction extends
        AbstractAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            SwitchControl sc = SwitchControl.getInstance();
            try {
                for (Switch s : sc.getNumberToSwitch()
                    .values()) {
                    sc.setStraight(s);
                }
    ...
    private void initToolbar()
    {
        ...
        JButton setAllSwitchesStraightButton = new JButton(new SwitchesStraightAction());

        JButton refreshButton = new JButton(new RefreshAction());

        JButton switchProgrammerButton = new JButton(new SwitchProgrammerAction());
    ...
    private void initStatusBar()
    {
        ...
        statusBarPanel.add(commandHistory,
            BorderLayout.SOUTH);
