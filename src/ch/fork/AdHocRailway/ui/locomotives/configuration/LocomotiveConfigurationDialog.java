...
public class LocomotiveConfigurationDialog extends JDialog {
    ...
    private JPanel createLocomotiveGroupPanel() {
        ...
        moveDownItem
            .addActionListener(new MoveLocomotiveGroupAction(false));
    ...
    private JPanel createLocomotivesPanel() {
        ...
        locomotivesPanel.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW)
            .put(
                ...
                "escapeAction");
        locomotivesPanel.getActionMap().put(
        ...
        JScrollPane switchGroupTablePane = new JScrollPane(
            locomotivesTable);
        ...
        removeLocomotiveButton
            .addActionListener(new RemoveLocomotiveAction());
    ...
    class MoveLocomotiveGroupAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            locomotiveGroups.add(newIndex, groupToMove);
