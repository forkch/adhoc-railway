...
public class PreferencesDialog extends
    JDialog
{
    ...
    private void initGUI()
    {
        ...
        preferencesPane.add(createGUISettingsTab(),
            "General Settings");
        preferencesPane.add(createDigitalDataTab(),
            "Digital Data");
        preferencesPane.add(createServerTab(),
            "Server");
        add(preferencesPane,
            BorderLayout.CENTER);
    ...
    private JPanel createGUISettingsTab()
    {
        ...
        JLabel locomotiveControlNumberLabel = new JLabel("Number of Locomotive Controls:");
        locomotiveControlNumberModel = new SpinnerNumberModel(5,
            1,
            10,
            1);
        locomotiveControlNumber = new JSpinner(locomotiveControlNumberModel);

        JLabel switchControlNumberLabel = new JLabel("Number of Switch Controls per row:");
        switchControlNumberModel = new SpinnerNumberModel(7,
            1,
            10,
            1);
        ...
        SpringUtilities.makeCompactGrid(guiSettingsTab,
            3,
            2, // rows, cols
            6,
            6, // initX, initY
    ...
    private JPanel createDigitalDataTab()
    {
        ...
        defaultActivationTimeModel = new SpinnerNumberModel(50,
            50,
            1000,
            10);
        ...
        defaultRoutingDelayModel = new SpinnerNumberModel(250,
            100,
            1000,
            10);
    ...
    private JPanel createServerTab()
    {
        ...
        portnumberTextField = new JTextField("12345",
            15);
    ...
    {
        defaultActivationTimeModel.setValue(p.getIntValue("DefaultActivationTime"));
        defaultRoutingDelayModel.setValue(p.getIntValue("DefaultRoutingDelay"));

        hostnameTextField.setText(p.getStringValue("Hostname"));
        portnumberTextField.setText(Integer.toString(p.getIntValue("Portnumber")));
        locomotiveControlNumberModel.setValue(p.getIntValue("LocomotiveControlesAmount"));
        switchControlNumberModel.setValue(p.getIntValue("SwitchControlesAmount"));
        keyBoardLayoutComboBox.setSelectedItem(p.getStringValue("KeyBoardLayout"));
    ...
    {
        p.setIntValue("DefaultActivationTime",
            defaultActivationTimeModel.getNumber()
                .intValue());
        p.setIntValue("DefaultRoutingDelay",
            defaultRoutingDelayModel.getNumber()
                .intValue());
       
        p.setStringValue("Hostname",
            (String) hostnameTextField.getText());
        p.setIntValue("Portnumber",
            Integer.parseInt(portnumberTextField.getText()));
        p.setIntValue("LocomotiveControlesAmount",
            locomotiveControlNumberModel.getNumber()
                .intValue());
        p.setIntValue("SwitchControlesAmount",
            switchControlNumberModel.getNumber()
                .intValue());
        p.setStringValue("KeyBoardLayout",
            keyBoardLayoutComboBox.getSelectedItem()
                .toString());

        p.setBooleanValue("Interface6051",
            interface6051.isSelected());
        p.setBooleanValue("WriteLog",
            interface6051.isSelected());
