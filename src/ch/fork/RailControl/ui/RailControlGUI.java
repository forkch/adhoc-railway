	...
	private void initToolbar() {
		...
		hostnamesComboBox.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				Preferences.getInstance().setStringValue("Hostname",
	...
	private class OpenAction extends AbstractAction {
		...
		private void openFile(File file) {
			...
			XMLImporter importer = new XMLImporter(Preferences.getInstance(),
					switchNumberToSwitch, switchGroups, locomotives, file
							.getAbsolutePath());
			switchGroupPane.update(switchGroups);
	...
	private class LocomotivesAction extends AbstractAction {
		public LocomotivesAction() {
			super("Locomotives", createImageIcon("icons/locomotive.png",
					"Locomotives", RailControlGUI.this));
		}
	...
	private class PreferencesAction extends AbstractAction {
		public PreferencesAction() {
			super("Preferences", createImageIcon("icons/package_settings.png",
					"Preferences", RailControlGUI.this));
		}
	...
	private class DisconnectAction extends AbstractAction {
		public DisconnectAction() {
			super("Disconnect", createImageIcon("icons/daemondisconnect.png",
					"Disconnect", RailControlGUI.this));
		}
	...
	private class SwitchesStraightAction extends AbstractAction {
		public SwitchesStraightAction() {
			super("", createImageIcon("icons/switch.png",
					"Set all switches straight", RailControlGUI.this));
		}
