...
import ch.fork.RailControl.ui.switches.SwitchesControlPanel;
...
public class RailControlGUI extends JFrame implements
	CommandDataListener,
	InfoDataListener
{
	...
	protected class SaveAction extends AbstractAction
	{
		public SaveAction()
		{
			super("Save", createImageIcon("icons/filesave.png",
				"Save",
				RailControlGUI.this));
		}
	...
	protected class ExitAction extends AbstractAction
	{
		public ExitAction()
		{
			super("Exit", createImageIcon("icons/exit.png",
				"Exit",
				RailControlGUI.this));
		}
		...
		public void actionPerformed(ActionEvent e)
		{
			int result = JOptionPane.showConfirmDialog(RailControlGUI.this,
				"Really exit ?",
				"Exit",
	...
	protected class SwitchesAction extends AbstractAction
	{
		...
		{
			super("Switches", createImageIcon("icons/switch.png",
				"Switches",
				RailControlGUI.this));
		}
		...
		public void actionPerformed(ActionEvent e)
		{
			SwitchConfigurationDialog switchConfig = new SwitchConfigurationDialog(RailControlGUI.this,
	...
	protected class LocomotivesAction extends AbstractAction
	{
		...
		{
			LocomotiveControl lc = LocomotiveControl.getInstance();
			LocomotiveConfigurationDialog locomotiveConfig = new LocomotiveConfigurationDialog(RailControlGUI.this,
				Preferences.getInstance());
		...
		public void actionPerformed(ActionEvent e)
		{
			try {
				...
				session.getCommandChannel()
					.addCommandDataListener(RailControlGUI.this);
				session.getInfoChannel()
					.addInfoDataListener(RailControlGUI.this);
	...
	protected class ResetAction extends AbstractAction
	{
		public ResetAction()
		{
			super("Reset", createImageIcon("icons/daemonreset.png",
				"Reset",
				RailControlGUI.this));
		}
	...
	protected class RefreshAction extends AbstractAction
	{
		...
		{
			super("Refresh", createImageIcon("icons/reload.png",
				"Refresh",
				RailControlGUI.this));
		}
	...
	protected class SwitchProgrammerAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			SwitchProgrammer sp = new SwitchProgrammer(RailControlGUI.this,
				session);
		}
	}
	...
	private void initToolbar()
	{
		...
		hostnamesComboBox.addActionListener(new ActionListener()
		{
			...
			{
				Preferences.getInstance()
					.setStringValue("Hostname",
						hostnamesComboBox.getSelectedItem()
							.toString());
			}
