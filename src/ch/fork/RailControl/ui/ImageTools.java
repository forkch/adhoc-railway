...
public class ImageTools {
    ...
    public static ImageIcon createDefaultSwitch(ImageObserver obs,
        Class comp) {
        ...
        g.drawImage(createImageIcon("icons/LED_up_yellow.png", "", comp)
            .getImage(), 28, 0, obs);
        g.drawImage(
            createImageIcon("icons/LED_middle_white.png", "", comp)
                .getImage(), 28, 0, obs);
    ...
    public static ImageIcon createDoubleCrossSwitch(ImageObserver obs,
        ...
        Graphics2D g = img.createGraphics();
        g.drawImage(
            createImageIcon("icons/double_cross_switch.png", "", comp)
                .getImage(), 0, 0, obs);
    ...
    public static ImageIcon createThreeWaySwitch(ImageObserver obs,
        Class comp) {
        BufferedImage img = new BufferedImage(56, 35,
            BufferedImage.TYPE_4BYTE_ABGR);
        Graphics2D g = img.createGraphics();
        g.drawImage(
            createImageIcon("icons/three_way_switch.png", "", comp)
                .getImage(), 0, 0, obs);

        g.drawImage(createImageIcon("icons/LED_up_white.png", "", comp)
            .getImage(), 28, 0, obs);
        g.drawImage(
            createImageIcon("icons/LED_middle_yellow.png", "", comp)
                .getImage(), 28, 0, obs);
    ...
    public static ImageIcon createStraightState(ImageObserver obs,
        Class comp) {
    ...
    public static ImageIcon createEastOrientation(ImageObserver obs,
        Class comp) {
        BufferedImage img = new BufferedImage(120, 35,
            BufferedImage.TYPE_4BYTE_ABGR);
        Graphics2D g = img.createGraphics();
    ...
    public static ImageIcon createWestOrientation(ImageObserver obs,
        Class comp) {
        BufferedImage img = new BufferedImage(120, 35,
            BufferedImage.TYPE_4BYTE_ABGR);
        Graphics2D g = img.createGraphics();
    ...
    public static ImageIcon createNorthOrientation(ImageObserver obs,
        Class comp) {
    ...
    public static ImageIcon createStraightSwitch(ImageObserver obs,
        Class comp) {
        BufferedImage img = new BufferedImage(56, 35,
            BufferedImage.TYPE_4BYTE_ABGR);
        Graphics2D g = img.createGraphics();
