...
public class XMLImporter_1_0 extends DefaultHandler implements ContentHandler {
	...
	public void startElement(String uri, String localName, String qName,
		...
		if (qName.equals("switchgroup")) {
			...
			boolean switched = Boolean.parseBoolean(attributes.getValue("switched"));
	...
	public void endElement(String uri, String localName, String qName)
		...
		if (qName.equals("switchgroup")) {
			...
			actualTurnout.setAddress1Switched(actualAddresses[0].isAddressSwitched());
			if (actualAddresses.length == 2) {
				...
				actualTurnout.setAddress2Switched(actualAddresses[1].isAddressSwitched());
			}
