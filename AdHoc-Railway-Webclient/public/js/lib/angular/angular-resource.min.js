...
(function (A, e, w) {
    ...
    e.module("ngResource", ["ng"]).factory("$resource", ["$http", "$parse", function (x, y) {
        ...
        var z = {get: {method: "GET"}, save: {method: "POST"}, query: {method: "GET", isArray: !0}, remove: {method: "DELETE"}, "delete": {method: "DELETE"}}, p = e.noop, l = e.forEach, i = e.extend, v = e.copy, r = e.isFunction;
