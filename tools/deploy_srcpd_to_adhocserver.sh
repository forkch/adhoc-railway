...
ssh -t baehnle@adhocserver 'cd ~/AdHoc-Railway-srcpd/srcpd && ./configure  --disable-ddl --disable-intellibox --disable-li100 --disable-zimo --disable-selectrix  --disable-m605x --disable-ddls88 --disable-i2cdev --disable-hsi88 && make clean && make && sudo make install && sudo service srcpd restart'
